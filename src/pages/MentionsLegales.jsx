  ...
  return (
    <main className="min-h-screen text-ghost font-sans bg-void">
      <Helmet>
        ...
        <link rel="canonical" href="https://www.hgoautomation.fr/mentions-legales" />
      </Helmet>
      ...
      <section className="pt-40 pb-24 px-8 md:px-24">
        <div className="max-w-3xl mx-auto">
          <span className="inline-block font-cond uppercase tracking-[0.18em] text-xs font-semibold text-cyan bg-void border-2 border-cyan rounded-full px-4 py-1.5 mb-8">Informations légales</span>
          ...
          <div className="space-y-10 text-sm font-light text-ghost/70 leading-relaxed">
            <section>
              <h2 className="font-cond text-ghost text-xl font-semibold uppercase tracking-wide mb-4 flex items-center gap-2">
          ...
          <div className="mt-16 pt-8 border-t border-ghost/10 flex gap-6 font-cond text-sm opacity-40">
